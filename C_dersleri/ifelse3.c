...
//!1.soru
// Bir alışveriş sitesinde 100 TL ve üzerine kargo bedava iken 100 TL altındaki alışverişlerde ise 20 TL kargo 
//ücreti alınmaktadır. Buna göre kullanıcıdan alışveriş tutarını alıp, kargo ücreti dahil ödemesi gereken 
//toplam tutarını ekrana yazdırınız.
// int main(){
// int fiyat;
// int kargoÜcreti=20;
...
//!3.soru
// Kullanıcıdan bir karakter girişi alan ve bu karakterin bir harf, rakam veya özel bir karakter
// olduğunu belirleyen bir program yazın. (ASCII tablosunu kullanarak)
// int main(){
//       char x;
